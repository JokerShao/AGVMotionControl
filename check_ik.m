function check_ik(chassis_w, chassis_h, chassis_omega, icc, r0, r1, r2, r3)
...
cross_x = [icc(1) corner_tl(1)+r0(1) corner_br(1)+r1(1) corner_bl(1)+r2(1) corner_tr(1)+r3(1)];
cross_y = [icc(2) corner_tl(2)+r0(2) corner_br(2)+r1(2) corner_bl(2)+r2(2) corner_tr(2)+r3(2)];
